...
bash install-package-from-libs-repository.sh GreenSense M2Mqtt 4.3.0.0 || exit 1

bash install-package-from-github-release.sh CompulsiveCoder ArduinoSerialControllerClient 1.1.1.13 || exit 1
